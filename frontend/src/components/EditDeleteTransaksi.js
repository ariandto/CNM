...
function EditDeleteTransaksi() {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    const { idtransaksi, ...dataToUpdate } = formData; // Exclude idtransaksi from update
    try {
      setLoading(true);
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h1 className="text-2xl font-semibold mb-4">Edit or Delete Transaksi Barang Masuk</h1>
